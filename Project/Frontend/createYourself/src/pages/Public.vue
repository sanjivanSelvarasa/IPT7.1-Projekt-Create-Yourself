              ...
              <div class="flex lg:flex-row flex-col-reverse mt-30 lg:mt-0 justify-between items-center gap-4">
                ...
                <div>
                  <div class="relative select-none w-[400px] h-[400px]">
                    ...
                    <div class="relative z-10 flex justify-center items-center w-full h-full overflow-hidden text-[80px] text-[var(--text-color-white)] font-extrabold rounded-full shadow-2xl bg-linear-to-br from-[var(--primary-color)] to-[var(--secondary-color)] border-5 border-[var(--background-color)]">
